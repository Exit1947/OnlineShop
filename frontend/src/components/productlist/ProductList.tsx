...
const products = [
  { id:1, src: image1, title: 'MacBook Air Pro 13-inch', price: '1,299.99 $', oldPrice: '1,499.99 $', rating: 4.5 },
  { id:2, src: image2, title: 'Samsung Galaxy s23 Ultra (Black)', price: '1,100.00 $', oldPrice: '1,300.00 $', rating: 5 },
  { id:3,src: image3, title: 'Apple Watch Series 8 (Sport Band)', price: '399.99 $', oldPrice: '499.99 $', rating: 4 },
  { id:4,src: image4, title: 'JBL Headphones Wireless E45', price: '59.99 $', oldPrice: '99.99 $', rating: 4.5 },
  { id:5,src: image5, title: 'Multi-function printer Epson L380', price: '399.99 $', oldPrice: '499.99 $', rating: 2.5 },
  { id:6,src: image6, title: 'PlayStation 5 (Blu-ray) 825 gb', price: '449.99 $', oldPrice: '499.99 $', rating: 5 },
  { id:7,src: image7, title: 'Xbox Wireless Controller', price: '79.99 $', oldPrice: '89.99 $', rating: 3.5 },
  { id:8,src: image8, title: 'JBL Boombox 2 (Black)', price: '499.99 $', oldPrice: '599.99 $', rating: 4.5 }
];
